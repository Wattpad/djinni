...
class ObjcGenerator(spec: Spec) extends Generator(spec) {
  ...
  override def generateEnum(origin: String, ident: Ident, doc: Doc, e: Enum) {
    ...
    writeObjcFile(spec.objcHeaderOutFolder.get, marshal.headerName(ident), origin, refs.header, w => {
      writeDoc(w, doc)
  ...
  override def generateInterface(origin: String, ident: Ident, doc: Doc, typeParams: Seq[TypeParam], i: Interface) {
    ...
    if (i.consts.nonEmpty) {
      ...
      writeObjcFile(spec.objcOutFolder.get, bodyName(ident.name), origin, refs.body, w => {
  ...
  override def generateRecord(origin: String, ident: Ident, doc: Doc, params: Seq[TypeParam], r: Record) {
    ...
    writeObjcFile(spec.objcHeaderOutFolder.get, marshal.headerName(objcName), origin, refs.header, w => {
      writeDoc(w, doc)
    ...
    writeObjcFile(spec.objcOutFolder.get, bodyName(objcName), origin, refs.body, w => {
