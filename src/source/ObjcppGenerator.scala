...
class ObjcppGenerator(spec: Spec) extends Generator(spec) {
  ...
  override def generateInterface(origin: String, ident: Ident, doc: Doc, typeParams: Seq[TypeParam], i: Interface) {
    ...
    writeObjcFile(spec.objcppHeaderOutFolder.get, objcppMarshal.privateHeaderName(ident.name), origin, refs.privHeader, w => {
      arcAssert(w)
      w.wl
    ...
    writeObjcFile(spec.objcppOutFolder.get, privateBodyName(ident.name), origin, refs.body, w => {
      arcAssert(w)
  ...
  override def generateRecord(origin: String, ident: Ident, doc: Doc, params: Seq[TypeParam], r: Record) {
    ...
    writeObjcFile(spec.objcppHeaderOutFolder.get, objcppMarshal.privateHeaderName(objcName), origin, refs.privHeader, w => {
      arcAssert(w)
      w.wl
    ...
    writeObjcFile(spec.objcppOutFolder.get, privateBodyName(objcName), origin, refs.body, w => {
      wrapNamespace(w, spec.objcppNamespace, w => {
  ...
  def writeObjcFile(folder: File, fileName: String, origin: String, refs: Iterable[String], f: IndentWriter => Unit) {
